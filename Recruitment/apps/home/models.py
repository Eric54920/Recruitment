...
class Company(BaseModel):
    ...
    companyLogo = models.CharField(max_length=128, verbose_name="公司Logo")
    companySize = models.SmallIntegerField(choices=companySizeChoices, verbose_name="公司规模")
    industryField = models.TextField(verbose_name="经营范围")
    financeStage = models.CharField(max_length=32, verbose_name="是否需要融资")
    companyLabelList = models.CharField(max_length=200, verbose_name="公司标签", help_text="多个标签之间用“|”分隔")
    businessLicense = models.CharField(max_length=128, verbose_name="营业执照")
    ...
    createPersonAvatar = models.CharField(max_length=128, verbose_name="创始人头像")
    signature = models.CharField(max_length=128, verbose_name="公司签名")
    companyIntro = models.TextField(verbose_name="公司介绍")
    companyIntroHtml = models.TextField(verbose_name="公司介绍Html")
    ...
    companyAddress = models.CharField(max_length=128, verbose_name="公司地址")
    latitude = models.CharField(max_length=32, verbose_name="纬度")
    longitude = models.CharField(max_length=32, verbose_name="经度")
    companyEmail = models.TextField(null=True, blank=True, verbose_name="企业邮箱列表")
    creator = models.ForeignKey(to="user.Account",on_delete=models.CASCADE, verbose_name="主页创建人")
    is_pass = models.BooleanField(choices=((0, '未通过审核'),(1, '通过审核')), null=True, blank=True, verbose_name="是否审核通过")
    message = models.TextField(null=True, blank=True, verbose_name="审核反馈信息")
    class Meta:
        verbose_name = '公司列表'
        verbose_name_plural = verbose_name
