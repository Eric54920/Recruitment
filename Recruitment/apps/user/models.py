...
class Account(AbstractUser):
    ...
    avatar = models.CharField(max_length=255, default="blob:http://www.offend.com:8080/16bcf686-9a9a-4e42-b1f2-6e6cac6e42b3", blank=True, null=True, verbose_name='头像')
...
class Focus(models.Model):
    follower = models.ForeignKey(to="Account", related_name="follower", on_delete=models.CASCADE, verbose_name="关注者")
    followed = models.ForeignKey(to="Account", related_name="followed", on_delete=models.CASCADE, verbose_name="被关注")

class ChatRecord(models.Model):
    send = models.ForeignKey(to="Account", related_name="send", on_delete=models.CASCADE, verbose_name="发送者")
    content = models.TextField(verbose_name="内容")
    receive = models.ForeignKey(to="Account", related_name="receive", on_delete=models.CASCADE, verbose_name="接收者")
