          ...
          <el-col :span="5">
            <div class="grid-content">
              <div class="com-avatar">
                <img v-if="company.companyLogo" :src="company.companyLogo" fit="cover">
        ...
        <el-row>
          <el-col :span="16">
            <div class="grid-content">
              <div class="com-desc">
                <h1>经营范围</h1>
                <p>{{ company.industryField }}</p>
                <h1>公司介绍</h1>
                <p v-html="company.companyIntroHtml"></p>
                <h1>公司位置</h1>
                <p><i class="fa fa-map-marker"></i> {{ company.companyAddress }}</p>
            ...
            <div class="grid-content">
              <div class="other-info">
                ...
                <div class="com-labels">
                  <span v-if="company.companyLabel != ''" v-for="(item, i) in company.companyLabel" :key="i">{{ item }}</span>
                  <p v-else>还没有添加标签</p>
                </div>
                <h1>工商信息</h1>
...
export default {
  ...
  methods: {
    async getCompany () {
      let response = await this.axios.get(`${this.settings.Host}/home/company/detail/${this.id}`)
