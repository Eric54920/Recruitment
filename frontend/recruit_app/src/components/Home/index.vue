    ...
    <div class="search-panel">
      <div class="container">
        <div class="search-wrapper">
          <input type="text" placeholder="你想从事什么工作？" v-model="searchCon"><button @click="search(this.searchCon)"><i class="el-icon-right"></i></button>
        </div>
      </div>
    </div>
    <div class="hero">
              ...
              <li class="menu-item" v-for="item in jobs" :key=item.id>
                ...
                <div class="sub-menu">
                  <dl v-for="sub_cate in item['sub_category']" :key=sub_cate.id>
                    ...
                    <dd><a href="javascript:;" v-for="cate in sub_cate['category']" :key=cate.id @click="search(cate.name)">{{ cate.name }}</a></dd>
                  </dl>
                </div>
              </li>
            </ul>
...
export default {
  ...
  methods: {
    ...
    search (searchCon) {
      this.$router.push(`/positions/?q=${searchCon}`);
    }
  }
}
</script>
