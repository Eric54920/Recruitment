            ...
            <div class="grid-content">
              <div class="info-saide">
                ...
                <ul>
                  ...
                  <li>
                    <a
                      :class="{'active': panel_id=='resume'}"
                      href="javascript:;"
                      @click="panel_id='resume';filters.page=1"
                    >
                      <i class="el-icon-document-checked"></i> 简历
                    </a>
                  </li>
                  <!-- <li>
                    <a
          ...
          <el-col :span="14">
            <div class="grid-content">
              ...
              <div class="info-content" v-if="panel_id == 'resume'">
                <a class="create" :href="`/createresume/${this.user_id}`" target="_blank">
                  <i class="el-icon-circle-plus-outline"></i> 创建简历
                </a>
                <div class="resume-wrapper">
                  <Resume
                    @removeItem="refresh_list()"
                    v-for="(item, i) in resume_list.results"
                    :key="i"
                    v-bind:item="item"
                    v-bind:userInfo="userInfo"
                  ></Resume>
        ...
        <el-tab-pane label="基本信息" name="first">
          <el-form :model="userInfo">
            ...
            <!-- <el-form-item label="任职公司" :label-width="formLabelWidth">
              <el-button>
                <el-link :underline="false" href="https://www.baidu.com" target="_blank">Tesla</el-link>
              </el-button>
            </el-form-item> -->
...
export default {
  ...
  methods: {
    ...
    // 获取动态，文章，收藏，简历
    async getData() {
      if (this.panel_id == "followed") {
        const response = await this.axios.get(`${this.settings.Host}/followed/${this.user_id}/`);
