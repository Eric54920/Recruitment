          ...
          <li class="top-item" v-if="this.token">
            <el-dropdown>
              ...
              <el-dropdown-menu slot="dropdown">
                <!-- 普通用户 -->
                <el-dropdown-item v-if="this.user_type==0"><router-link tag="p" to="/profile/"><i class="fa fa-user"></i> 个人信息</router-link></el-dropdown-item>
                <el-dropdown-item v-if="this.user_type==0"><router-link tag="p" to="/delivery/"><i class="fa fa-file-text-o"></i> 投递记录</router-link></el-dropdown-item>
                <el-dropdown-item v-if="this.user_type==0 && this.company"><router-link tag="p" :to="`/manage/company/${this.company}`"><i class="fa fa-users"></i> 公司主页</router-link></el-dropdown-item>
                <!-- 企业用户 -->
                <el-dropdown-item v-if="this.user_type==1"><router-link tag="p" to="/manage/"><i class="fa fa-home"></i> 管理中心</router-link></el-dropdown-item>
                <el-dropdown-item v-if="this.user_type==1"><router-link tag="p" to="/received/"><i class="fa fa-file-pdf-o"></i> 已收简历</router-link></el-dropdown-item>
                <el-dropdown-item v-if="this.user_type==1"><router-link tag="p" to="/resumes/"><i class="fa fa-users"></i> 寻找人才</router-link></el-dropdown-item>
                <el-dropdown-item><el-link :underline="false" @click="logout"><i class="fa fa-sign-out"></i> 退出登录</el-link></el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
          </li>
        </ul>
        ...
        if (valid) {
          ...
          this.axios
            ...
            .then(response => {
              ...
              sessionStorage.company = response.data.company;
